        ...
        <div class="container max-w-5xl mx-auto m-8">
          <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
              ...
              <p class="text-gray-600 mb-8">
                Program studi Teknik Jaringan Komputer Telekomunikasi akan
                membekali siswa dengan pengetahuan dan keterampilan dalam
                merancang, mengelola, dan memelihara infrastruktur jaringan
                komputer yang handal. Siswa akan mempelajari protokol
                komunikasi, keamanan jaringan, manajemen jaringan, dan teknologi
                telekomunikasi modern seperti VoIP dan 5G
                <br />
                <br />
                <a class="btn btn-info btn-wide" href="/programkeahlian">
                  Detail
                </a>
              </p>
            </div>
        ...
        <div class="container max-w-5xl mx-auto m-8">
          <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
              ...
              <p class="text-gray-600 mb-8">
                Program studi Desain Komunikasi Visual akan memandu siswa dalam
                mengembangkan kreativitas mereka dalam bidang desain grafis dan
                visual. Siswa akan belajar untuk merancang komunikasi visual
                yang efektif melalui penggunaan elemen-elemen seperti warna,
                tipografi, ilustrasi, dan multimedia. Mereka juga akan memahami
                bagaimana desain dapat memengaruhi pesan dan interaksi dalam
                berbagai konteks.
                <br />
                <br />
                <a class="btn btn-info btn-wide" href="/programkeahlian">
